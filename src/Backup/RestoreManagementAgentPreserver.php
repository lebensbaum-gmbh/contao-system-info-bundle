...
final class RestoreManagementAgentPreserver
{
    ...
    private function resolvePhpCli(): array
    {
        ...
        throw new RuntimeException(sprintf(
            'Für den Erhalt von System Info wurde kein zur Web-PHP-Version %s passendes PHP-CLI gefunden. Der PHP-Pfad kann über CONTAO_SYSTEM_INFO_PHP_CLI vorgegeben werden.',
            $expectedVersion
        ));
    }
